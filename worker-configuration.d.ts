...
// Updated for Marduk ML SDK integration (orgitcog/mad9ml)
declare namespace Cloudflare {
	...
	interface Env {
		...
		PLATFORM_CAPABILITIES: {"features":{"app":{"enabled":true},"presentation":{"enabled":false},"general":{"enabled":false},"cognitive":{"enabled":true}},"version":"1.0.0"};
