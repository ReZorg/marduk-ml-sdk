...
export const ProjectTypePredictionSchema = z.object({
    projectType: z.enum(['app', 'workflow', 'presentation', 'general', 'cognitive']).describe('The predicted type of project based on the user query'),
...
export const TemplateSelectionSchema = z.object({
    ...
    projectType: z.enum(['app', 'workflow', 'presentation', 'general', 'cognitive']).default('app').describe('The type of project based on the user query'),
});
